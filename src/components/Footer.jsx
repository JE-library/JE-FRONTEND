  ...
  <footer className="bg-gray-800 text-white py-8 grid grid-rows-4">
    ...
    <div>
      <h3 className="font-semibold text-lg mb-2">About Us</h3>
          <p>
            We are passionate about healthy eating and healthy ingredients. Our mission is to connect food lovers
            with their next great meals.
          </p>

          <div>
            <h3 className="font-semibold text-lg mb-2 text-amber-300" >Follow Us</h3>
