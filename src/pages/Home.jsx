...
function Home () {
  return ( <PagesLayout>
    <section id='hero' className='bg-center h-180 ' >
      <img src="https://cdn.pixabay.com/photo/2018/03/14/20/04/panorama-3226254_1280.jpg" alt="heroimg" className='bg-cover bg-no-repeat h-screen bg-center' />
  <div>
...
<section className='grid grid-cols-2  p-2' id='about'>
  <div className='about-left'>
    ...
    <p>At JE Library, we don’t just store books — we celebrate them.</p><br/>
  
  </div>
<img src='https://cdn.pixabay.com/photo/2018/01/08/08/47/digitization-of-library-3068971_640.jpg 'className="w-0" alt='aboutimg'/>
</section>
